...
const ReticleCanvas = props => {
  ...
  return <canvas height='580' width='580' className='ObsWindowCanvas' ref={reticleCanvasRef} {...rest} />
}

export default ReticleCanvas;